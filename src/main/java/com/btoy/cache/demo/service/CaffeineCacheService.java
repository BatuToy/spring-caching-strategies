package com.btoy.cache.demo.service;
...
public class CaffeineCacheService { // L1 Caffeine Cache service !!!

    private static final Logger log = Logger.getLogger(CaffeineCacheService.class.getSimpleName());
